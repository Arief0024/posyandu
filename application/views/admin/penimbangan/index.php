                ...
                <div class="x_content">
                    ...
                    <form id="penimbangan-form" name="penimbangan-form" class="form-horizontal form-label-left"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="input-group">
                                    <input class="date-picker form-control" name="tgl_lahir" id="tgl_lahir" type="text"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <p style="margin-top: 5px !important;margin-bottom: -2rem !important;">
                                    <input type="radio" class="flat" name="deteksi[]" id="deteksiS" value="Sesuai"
                                        checked="" /> Sesuai
                                    <input type="radio" class="flat" name="deteksi[]" id="deteksiT"
                                        value="Tidak Sesuai" /> Tidak Sesuai
                                </p>
                            </div>
                        </div>
                        <div class="form-group row">
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $d['nama_ibu']; ?></td>
                                                <td>
                                                    <button id="pilihAnak" type="button" data-id="<?= $d['id_anak']; ?>"
